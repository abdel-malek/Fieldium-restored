 ...
 */
public class DeclinedReportActivity extends MasterActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_declined_report);
    ...
    void getFieldReport(){
        DeclinedsReservationsReport.setTotal(0);
        ShowProgressDialog();
        ...
        ReportsController.getInstance(getmController()).declinedReservationsReport(currentFieldID, fromDateString, toDateString, new SuccessCallback<DeclinedsReservationsReport>() {
            @Override
            public void OnSuccess(DeclinedsReservationsReport result) {
                HideProgressDialog();
                ...
                reportsAdapter=new ReportsAdapter(DeclinedReportActivity.this,R.layout.report_item,result.getFieldReservationsReports(),report_listView,currentFieldID==0?true:false);
    ...
    void assignActions() {
        ...
        from_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new android.app.DatePickerDialog(DeclinedReportActivity.this, new android.app.DatePickerDialog.OnDateSetListener() {
                    @Override
