...
public class AboutActivity extends MasterActivity {
    ...
    void showData() {
        if(appInfo.getEmail().equals("")){
            findViewById(R.id.info_email).setVisibility(View.GONE);
        }else{
            findViewById(R.id.info_email).setVisibility(View.VISIBLE);
            ((TextView)findViewById(R.id.info_email)).setText("Email: "+appInfo.getEmail());
        }
        if(appInfo.getPhone().equals("")){
            findViewById(R.id.info_phone).setVisibility(View.GONE);
        }else{
            findViewById(R.id.info_phone).setVisibility(View.VISIBLE);
            ((TextView)findViewById(R.id.info_phone)).setText("Phone: "+appInfo.getPhone());
        }
        if(appInfo.getMobile().equals("")){
            findViewById(R.id.info_mobile).setVisibility(View.GONE);
        }else{
            findViewById(R.id.info_mobile).setVisibility(View.VISIBLE);
