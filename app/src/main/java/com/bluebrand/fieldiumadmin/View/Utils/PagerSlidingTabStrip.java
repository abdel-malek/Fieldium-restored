...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabTextColor = R.color.black;
	...
	public void setVertcalDotsButton(ImageButton dotsButton)
	{
		this.dotsButton=dotsButton;
	}
	...
	private void addTab(final int position, View tab) {
		...
		/*tab.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				final Menu currentMenu=((MenuActivity)getContext()).getMenu().getSubMenus().get(position);
				if( currentMenu.getDishes().size()!=0)
				{
					final CharSequence[] items = {"Edit","Add New Dish","Delete"};
					AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
					builder.setItems(items, new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int item) {
							if (items[item].equals("Edit")) {
								editMainCat(currentMenu);
							} else if (items[item].equals("Add New Dish")) {
								addNewDish(currentMenu);
							}
							else if (items[item].equals("Delete")) {
								deleteMainCat(currentMenu);
							}
						}
					});
					builder.show();
				...
				else
				{
					...
					{
						final CharSequence[] items = {"Edit","Add New Sub Category","Delete"};
						AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
						builder.setItems(items, new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, int item) {
								if (items[item].equals("Edit")) {
									editMainCat(currentMenu);
								} else if (items[item].equals("Add New Sub Category")) {
									addNewSubCat(currentMenu);
								}
								else if (items[item].equals("Delete")) {
									deleteMainCat(currentMenu);
								}
					...
					{
						final CharSequence[] items = {"Edit","Add New Dish","Add New Sub Category","Delete"};
						AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
						builder.setItems(items, new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, int item) {
