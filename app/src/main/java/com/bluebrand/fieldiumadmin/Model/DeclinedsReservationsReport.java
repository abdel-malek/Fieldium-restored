 ...
 */
public class DeclinedsReservationsReport {
    ...
    public static void setTotal(int total) {
        DeclinedsReservationsReport.total = total;
    }
    ...
    public void newFieldReservationsReport(int field_id, String field_name, int booking_id, String string_date, String string_start, int duration, int player_id, String player_name, Boolean manually, int total){
        DeclinedReservationsReport declinedReservationsReport =new DeclinedReservationsReport(field_id, field_name, booking_id, string_date, string_start, duration, player_id, player_name, manually, total);
        fieldReservationsReports.add(declinedReservationsReport);
    }

    public class DeclinedReservationsReport extends ReportItem {
        ...
        public DeclinedReservationsReport(int field_id, String field_name, int booking_id, String string_date, String string_start, int duration, int player_id, String player_name, Boolean manually, int total) {
