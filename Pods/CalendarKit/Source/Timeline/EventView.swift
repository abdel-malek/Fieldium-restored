...
open class EventView: UIView {
  ...
  weak var delegate: EventViewDelegate?
    ...
    public var isEmpty = false{
        didSet{
            if isEmpty{
            //backgroundColor = .clear//UIColor(red: color.redComponent, green: color.greenComponent, blue: color.blueComponent, alpha: 0.3) // TO DO
            }
        }
    }
  ...
  public var color = UIColor() {
    didSet {
      ...
      backgroundColor = UIColor(red: color.redComponent, green: color.greenComponent, blue: color.blueComponent, alpha: 0.3) // TO DO
    }
  }
