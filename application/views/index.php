        ...
        <div id="section1" class="header">
            <div class="container clearfix">
                <div class="header-text pull-left">
                    ...
                    <div class="store">
                        <a href="#"><img src="<?php echo base_url() ?>assets/images/appstore.png" alt=""></a>
                        <a href="#"><img src="<?php echo base_url() ?>assets/images/playstore.png" alt=""></a>
                    </div>
                </div>

                <div class="pull-right">
                    <img src="<?php echo base_url() ?>assets/images/fieldium%20mobile%20mockup.png" alt="">
        ...
        <nav id="myScrollspy" class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="<?php echo base_url() ?>assets/images/fieldium_logo.png" alt=""></a>
                </div>
            ...
            <div class="container">
                <div id="section2" class="about_trainer">
                    ...
                    <div class="row about_box">
                        ...
                        foreach ($games as $game):
                            ...
                            <div class="col-md-6 sp_av">
                                <div class="<?php echo $class ?> box">
                                    <div class="box1_left">
                                        <a href="<?php echo $game->game_type_id ?>"><img style="width: 100px; height: 160px" src="<?php echo UPLOADED_IMAGES_PATH . $game->image ?>" class="img-responsive" alt=""/></a>
                        ...
                        <!--                    <div class="box2">-->
                        <!--                        <div class="box1_left">-->
                        <!--                            <img src="--><?php //echo base_url()  ?><!--assets/images/cricket.png" class="img-responsive" alt=""/>-->
                        <!--                            <div class="desc2">-->
                        ...
                        <!--                    <div class="box2">-->
                        <!--                        <div class="box1_left">-->
                        <!--                            <img src="--><?php //echo base_url()  ?><!--assets/images/tennis.png" class="img-responsive" alt=""/>-->
                        <!--                            <div class="desc2">-->
                        ...
                        <!--                    <div class="box1">-->
                        <!--                        <div class="box1_left">-->
                        <!--                            <img src="--><?php //echo base_url()  ?><!--assets/images/soccer.png" class="img-responsive" alt=""/>-->
                        <!--                            <div class="desc1">-->
...
<?php $count = 0; ?>
        ...
        <?php } ?>
                                            <div class="col-sm-4"><a href="#">
                                                    ...
                                                    <div class="view view-fifth">
                                                        <img src="<?php echo (count($featured_place->images) != 0) ? UPLOADED_IMAGES_PATH .$featured_place->images[0]->name : "" ?>" class="img-responsive2"  onerror="imgError(this);"/>
                                                        <div class="mask">
                                                            <ul class="desc_info">
    ...
    <?php } ?>
                  <div class="col-lg-3">
                    <img src="<?php echo base_url() ?>assets/images/pi.jpg" class="img-responsive2"  onerror="imgError(this);"/>
                  </div>
<?php } ?>
            </div>
          </div>
                ...
                <div class="container">
                    <div class="col-md-8 contact-top">
                        ...
                        <form method="post" action="<?php echo base_url() ?>index.php/site/send_message" id="contactForm">
                            <div class="to">
                                <input type="text" class="text" id="Name" name="name" value="Name" onfocus="this.value = '';" onblur="if (this.value == '') {
                                            this.value = 'Name';
                                        }">
                                <input type="email" class="text" id="Email" name="email" value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {
                                            this.value = 'Email';
                                        }" style="margin-left:20px">
                                <input type="text" class="text" id="Subject" name="subject" value="Subject" onfocus="this.value = '';" onblur="if (this.value == '') {
                                            this.value = 'Subject';
                                        }" style="margin-left:20px">
                            </div>
                            <div class="text">
                                <textarea id="Text" name="text" value="Message:" onfocus="this.value = '';" onblur="if (this.value == '') {
                                            this.value = 'Message';
                                        }">Message:</textarea>
                            </div>
                ...
                <div class="row section group">
                    <div class="col-md-4">
                        ...
                        <form class="subscribe">
                            <input type="text" value="Insert Email" onfocus="this.value = '';" onblur="if (this.value == '') {
                    ...
                    <div class="col-md-4">
                        <div class="f-logo">
                            <img src="<?php echo base_url() ?>assets/images/fieldium_logo_white.png" alt=""/>
                        </div>
