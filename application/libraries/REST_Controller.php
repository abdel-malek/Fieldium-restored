...
//                        $data['language'] = $this->response->lang;
//                        $this->data['content'] = $this->load->view($data_keys[0], $data, TRUE);
//                        $output = $this->data['content'];
//                    } else {
                $content = $data;
                $output = $this->format->factory($content)->{'to_' . $this->response->format}();
//                    }
//                }else {
//                    if ($this->response->format == "html" ) {
//                        $this->data['content'] = $this->load->view("error", array($message => $data ) , TRUE);
//                        $output = $this->data['content'];
//                    } else {
//                        $content = array('status'=>'error','data'=>"",'message'=>$data);
//                        $output = $this->format->factory($content)->{'to_' . $this->response->format}();
//                    }
//                }
            }
...
//        }
    ...
    /**
     * Check if the user is logged in.1
     *
