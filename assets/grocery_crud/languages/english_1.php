<?php
	...
	$lang['update_success_message'] = 'Your data has been successfully updated.<script type="text/javascript">
                 setTimeout(func, 2000);
		  function func() {$("#list-report-success").fadeOut("");}
		 </script>';
	$lang['form_go_back_to_list'] 	= 'Go back to list';

	$lang['form_add'] 				= 'Add';
	$lang['insert_success_message'] = 'Your data has been successfully stored into the database.<script type="text/javascript">
                 setTimeout(func, 2000);
		  function func() {$("#list-report-success").fadeOut("");}
		 </script>';
	$lang['form_or']				= 'or';
